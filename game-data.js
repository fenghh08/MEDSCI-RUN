/* ============================================================================
   ...
   and the Contributor tool (developer-tool.html) live in this one file.
   ...
   HOW TO ADD CONTENT
   -------------------
   • Easiest: open developer-tool.html, fill in the form, it writes the object
...
/* ======================================================================
  ...
  const COURSES = {
    MEDS3002: {
      ...
      classes: {
        L1:  { label: 'Transcriptional regulation of gene expression, genome organisation' },
        L2:  { label: 'Epigenetic markers' },
        L3:  { label: 'RNA splicing' },
        L4:  { label: 'Gene Editing Tech' },
        L5:  { label: 'Growth factor receptors and intracellular signalling pathway' },
        L6:  { label: 'Cell division and checkpoints' },
        L7:  { label: 'Cell differentiation' },
        L8:  { label: 'Cellular senescence' },
        L9:  { label: 'Immune cell differentiation and haematopoiesis' },
        L10: { label: 'Innate vs adaptive immune response' },
        L11: { label: 'Immune surveillance and cancer' },
        L12: { label: 'Immune cell profiling and biomarkers' },
        L13: { label: 'Cancer diagnostic' },
        L14: { label: 'Cancer Hallmarks' },
        L15: { label: 'Combination therapies in Cancer' },
        L16: { label: 'Metabolism of Cancer Cells' },
        L17: { label: 'TME and metabolism' },
        L18: { label: 'Cancer stem cells' },
        L19: { label: 'Angio & lymphangiogenesis' },
        L20: { label: 'Tumour Vasculature' },
        L21: { label: 'Anti-angiogenic drugs' },
        L22: { label: 'PK PD challenges cancer' },
        L23: { label: 'New RNA therapeutics' },
        L24: { label: 'Intro to immunotherapies' },
        L25: { label: 'Future directions of cancer therapy' },
        L26: { label: 'Transplant rejection' },
        L27: { label: 'Transplant acceptance' },
        L28: { label: 'Intro to HSCT' },
        L29: { label: 'Complications of HSCT' },
        L30: { label: 'Immunosuppressive therapy and diagnostics' },
        L31: { label: 'iPSC Personalised Medicine' },
        L32: { label: 'Overview of adoptive T cell therapies' },
        L33: { label: 'Complications of CAR-T cell immunotherapy' },
        L34: { label: 'Drug Discovery' },
        L35: { label: 'Clinical trials' },
        L36: { label: 'Cell and animal drug development' },
        L37: { label: 'NAMs' },
      },
    },
    MEDS2003: {
      ...
      label: 'Biochemistry',
      classes: {
        L1:  { label: 'Intro to Metabolism' },
        L6:  { label: 'Gluconeogenesis, Proteolysis and Ketone Body Synthesis' },
...
/* ======================================================================
   ...
   ====================================================================== */
  const TOPICS = {
    genetics:     { label:'Genetics',     icon:'🧬', color:'#c58bff' },
    immunology:   { label:'Immunology',   icon:'🛡️', color:'#3ec6e0' },
    pharmacology: { label:'Pharmacology', icon:'💊', color:'#ff4d6d' },
    oncology:     { label:'Oncology',     icon:'🎗️', color:'#ffab4d' },
    metabolism:       { label:'Metabolism',        icon:'🔥', color:'#ffd23f' },
    molecularBiology: { label:'Molecular Biology',  icon:'🔬', color:'#7cff6b' },
    cellBiology:      { label:'Cell Biology',        icon:'🧫', color:'#2dd4bf' },
    pharmacologyHistory: { label:'Pharmacology History', icon:'📜', color:'#f472b6' },
  };
          ...
          items: {
            ...
            flt3itd: {
              ...
              questions: [
                {
                  id: 'g3',
                  prompt: 'FLT3-ITD mutations are most commonly associated with which leukemia?',
                  options: ['Acute myeloid leukemia (AML)', 'Chronic lymphocytic leukemia (CLL)', 'Hairy cell leukemia', 'CML'],
                  correctIndex: 0,
                  explanation: 'FLT3 internal tandem duplications occur in about 25% of AML cases and confer a proliferative signal.',
                  hashtags: ['Leukemia'],
                },
                {
                  id: 'g4',
                  prompt: 'What does "ITD" stand for in FLT3-ITD?',
                  options: ['Internal tandem duplication', 'Intracellular transcription domain', 'Immune tolerance defect', 'Inverted terminal deletion'],
                  correctIndex: 0,
                  explanation: 'ITD refers to a duplicated segment inserted in tandem within the FLT3 gene, causing constitutive activation.',
                  hashtags: ['Leukemia'],
                },
                {
                  id: 'g10',
                  prompt: 'Which drug class specifically targets FLT3-mutated leukemia?',
                  options: ['FLT3 inhibitors (e.g. midostaurin)', 'Anti-CD20 monoclonal antibodies', 'Aromatase inhibitors', 'PARP inhibitors'],
                  correctIndex: 0,
                  explanation: 'FLT3 inhibitors like midostaurin and gilteritinib directly target the mutant, constitutively active kinase.',
                  hashtags: ['Leukemia'],
                },
              ],
            },
            npm1: {
              ...
              questions: [
                {
                  id: 'g5',
                  prompt: 'NPM1 mutation in AML (without FLT3-ITD) is generally associated with which prognosis?',
                  options: ['Favorable prognosis', 'Universally fatal', 'No prognostic value', 'Only relevant in CML'],
                  correctIndex: 0,
                  explanation: 'Isolated NPM1 mutation without FLT3-ITD is generally associated with a more favorable prognosis in AML.',
                  hashtags: ['Leukemia'],
                },
                {
                  id: 'g6',
                  prompt: 'Mutant NPM1 protein is characteristically found where in the cell?',
                  options: ['Mislocalized to the cytoplasm', 'Mislocalized to mitochondria', 'Secreted extracellularly', 'Unchanged, still nucleolar'],
                  correctIndex: 0,
                  explanation: 'Mutant NPM1 gains a nuclear export signal, causing abnormal cytoplasmic localization used diagnostically.',
                  hashtags: ['Leukemia'],
                },
              ],
            },
            cebpa: {
              ...
              questions: [
                {
                  id: 'g7',
                  prompt: 'CEBPA mutations in AML affect a protein involved in which process?',
                  options: ['Myeloid differentiation (transcription factor)', 'DNA mismatch repair', 'Angiogenesis', 'Cell membrane transport'],
                  correctIndex: 0,
                  explanation: 'CEBPA encodes a transcription factor essential for normal myeloid differentiation; mutation blocks maturation.',
                  hashtags: ['Leukemia'],
                },
              ],
            },
